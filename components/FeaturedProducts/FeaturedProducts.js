...
//         <div className="p-2 border border-gray-300 bg-white shadow-md mr-10 flex items-center justify-center">
...
//             <div
//               key={product.id}
//               className="bg-white rounded-lg w-40 flex flex-col items-center p-4 cursor-pointer"
...
//         <div className="p-2 border border-gray-300 bg-white shadow-md ml-10 flex items-center justify-center">
...
//       <div className="flex flex-row gap-2 mb-20 mt-12 items-center mt-4">
